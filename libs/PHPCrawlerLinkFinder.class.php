...
class PHPCrawlerLinkFinder
{
  ...
  /**
   * Selectors for DOM nodes to exclude from the link finder. Should be a two-dimensional array with the selector and index.
   * Set index to null to exclude all occurences.
   * <p />
   * <pre>
   * [
   *    ['head',0],
  ...
  /**
   * Selectors for DOM nodes to search exclusively for. Should be a two-dimensional array with the selector and index.
   * Set index to null to include all occurences.
   * <p />
   * <pre>
   * [
   *    ['div.listing',null],
