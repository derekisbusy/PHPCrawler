...
class PHPCrawler
{
  ...
  { 
    ...
    // simple_html_dom_node-class
    if (!class_exists("simple_html_dom_node")) include_once $classpath."/../simple_html_dom.php";
  ...
  protected function initCrawlerProcess()
  {
    ...
    elseif ($this->url_cache_type == PHPCrawlerUrlCacheTypes::URLCACHE_MYSQL)
